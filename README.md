...
Owner-friendly controls are available at `http://127.0.0.1:8000/owner/` for staff users. Use this page to update homepage details, phone/email contact preference, restaurant photos, today's and scheduled recommended dishes, owner-written review highlights, discounts, and upcoming events.
